...
class SolicitudServicio(BaseUrls, models.Model):
    ...
    tipo_servicio = models.ForeignKey(TipoServicio, on_delete=models.DO_NOTHING, blank=True, null=True)
    tipo_obras = models.ForeignKey(TipoObra, on_delete=models.DO_NOTHING, blank=True, null=True)
    servicio_ingenieria = models.CharField(max_length=100, blank=True, null=True)
    otros = models.CharField(verbose_name='Otros', max_length=100, blank=True, null=True)
    otros1 = models.CharField(verbose_name='Otros', max_length=100, blank=True, null=True)
    descripcion = models.CharField(max_length=100, blank=True, null=True)
    area_estudio = models.BooleanField(editable=True, default=False)
    resp_organos_consulta = models.BooleanField(editable=True, default=False)
    certif_micro = models.BooleanField(editable=True, default=False)
    tarea_proyeccion = models.BooleanField(editable=True, default=False)
    tarea_tecnica = models.BooleanField(editable=True, default=False)
    info_digital = models.BooleanField(editable=True, default=False)
    planos = models.BooleanField(editable=True, default=False)
    licencia_construccion = models.BooleanField(editable=True, default=False)
    licencia_ambiental = models.BooleanField(editable=True, default=False)
    est_ing_ecologico = models.BooleanField(editable=True, default=False)
    otros_documentos = models.CharField(max_length=100, blank=True, null=True)
    ...
    num_contrato = models.CharField(max_length=100, blank=True, null=True)
    fecha_aprobacion = models.DateField(blank=True, null=True)
    fecha_paralizacion = models.DateField(blank=True, null=True)
    fecha_reanudacion = models.DateField(blank=True, null=True)
...
class Ofertas(BaseUrls, models.Model):
    ...
    fecha_entrega_prep_tec = models.DateField(blank=True, null=True)
