...
class OT(BaseUrls, models.Model):
    ...
    fecha_recepcion = models.DateField(verbose_name='Fecha de Recepción de Solicitud')
    fecha_aprobacion = models.DateField(verbose_name='Fecha de Aprobación de Solicitud')
    fecha_entrega_pt = models.DateField(verbose_name='Fecha de Entrega de la PT')
    fecha_terminado_contrato = models.DateField(verbose_name='Fecha de Terminado Contrato')
    fecha_entrega_cliente = models.DateField(verbose_name='Fecha Entrega al Cliente')
    fecha_firma_contrato = models.DateField(verbose_name='Fecha de Firma del Contrato')
    fecha_recepcion_contrato = models.DateField(verbose_name='Fecha de Recepción del Contrato')
