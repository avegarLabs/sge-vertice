...
class Trabajador(BaseUrls):
    ...
    escala_salarial_reforna = models.ForeignKey(adm.EscalaSalarialReforma, on_delete=models.DO_NOTHING)
    ...
    def salario_escala_reforma(self):
        return adm.EscalaSalarialReforma.objects.get(grupo=self.escala_salarial.escala_reforma.grupo).salario_escala

    @property
    def grupo_escala_reforma(self):
        return adm.EscalaSalarialReforma.objects.get(grupo=self.escala_salarial.escala_reforma.grupo).grupo
