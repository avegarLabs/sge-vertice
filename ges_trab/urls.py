...
urlpatterns = [
    ...
    path('reportes/trabajadores/', include([
        ...
        path('resumen-plantilla/', views.preview_resumen_plantilla, name='resumen-plantilla'),
        path('total_escolaridad_categoria/export/', views.export_total_escolaridad_categoria, name='total_escolaridad_categoria_report'),
        path('total_escolaridad_categoria/', views.preview_total_escolaridad_categoria, name='total_escolaridad_categoria'),
        path('total_etnia_categoria/export/', views.total_etnia_categoria, name='total_etnia_categoria_report'),
        path('total_etnia_categoria/', views.preview_total_etnia_categoria, name='total_etnia_categoria'),
