...
urlpatterns = [
    ...
    path('reportes/trabajadores/', include([
        ...
        path('total_escolaridad_categoria/preview/', views.preview_total_escolaridad_categoria, name='total_escolaridad_categoria'),
        path('total_etnia_categoria/export/', views.export_total_etnia_categoria, name='total_etnia_categoria_report'),
