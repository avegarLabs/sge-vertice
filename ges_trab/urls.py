...
urlpatterns = [
    path('trabajadores/', include([
        ...
        path('chequeo_medico/<int:pk>/', views.exportar_chequeo_medico, name='Chequeomedicotrab'),
        path('chequeo_medico_especializado/<int:pk>/', views.exportar_chequeo_medicoesp, name='Chequeomedicoesp'),
        ...
        path('select_salarioescala_resolucion/<int:pk>/<str:codigo_resolucion>/', views.salarioescala_por_resolucion, name='SelectEscalasalarialPorResol'),
        ...
        path('trabajador_por_ci/<str:ci>/', views.trabajador_por_ci, name='TrabajadorPorCI'),
