...
urlpatterns = [
    ...
    path('reportes/trabajadores/', include([
        ...
        path('escolaridad_categoria/export/', views.escolaridad_categoria_export, name='escolaridad_categoria_export'),
        path('escolaridad_categoria/preview/', views.escolaridad_categoria_preview, name='escolaridad_categoria_preview'),
