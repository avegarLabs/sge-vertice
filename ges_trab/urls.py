...
urlpatterns = [
    ...
    path('reportes/trabajadores/', include([
        ...
        path('total_etnia_categoria/export/', views.export_total_etnia_categoria, name='total-etnia_categoria_report'),
        path('total_etnia_categoria/preview/', views.preview_total_etnia_categoria, name='total-etnia_categoria'),
