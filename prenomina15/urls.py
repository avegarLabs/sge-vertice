...
urlpatterns = [
    ...
    path('planos/<obra>', login_required(views.gestionar_plano), name='gestionarPlano'),
    ...
    path('exportar_datos_86/', login_required(views.exportar_datos86), name='exportarDatos86'),
    ...
    path('exportar_certifico86/<obra>/<fecha_ini>/<fecha_fin>/<recibido_por>/<cargo>/<org>/',
         login_required(views.exportar_certifico86),
         name='exportarCertifico86'),
